...
import img from '../image/science.jpg';
...
const InstructorPage = (props) => {
    ...
    const CommunityMapper = () => {
        ...
        return data.map((data, index) => {
            ...
            let date = new Date(data.updatedAt).toLocaleDateString("en-US")
            return (
    ...
    const renderMenu = (
        ...
        >
            ...
            <MenuItem><Link to ='/signin'onClick={props.clearToken}>Log Out</Link></MenuItem>
        </Menu>
    );
...
// import { CourseList, CourseEdit, CourseCreate} from './CourseList';


// const InstructorPage = (props)=>{
//     const [dataProvider, 
//     setDataProvider] = useState([])
//     const fetchCourses = () => {
//         fetch(`${APIURL}/course/mycourses`, {
//             method: 'GET',
//             headers: new Headers({
